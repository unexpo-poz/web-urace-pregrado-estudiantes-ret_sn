...
$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/retiros/retiros_sin_normativa'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	...
	$tProceso	= 'Retiro de Asignaturas para Estudiantes Regulares';
}
